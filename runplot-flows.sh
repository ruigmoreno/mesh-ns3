...
do
	...
	do
		...
		rm $path_results/PreqPerNode/Preq-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s
		rm $path_results/PrepPerNode/Prep-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s
		rm $path_results/PerrPerNode/Perr-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s
		rm $path_results/PreqTotal/PreqTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s
		rm $path_results/PrepTotal/PrepTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s
		rm $path_results/PerrTotal/PerrTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s
		...
		# perr_perNode=`echo "scale=2; $sum_Perr/$nb_nodes" | bc`
		cd $path_NS3
		chmod -R 755 confidenceIntervalAdaptation.sh
		...
		./confidenceIntervalAdaptation.sh ci=95  $path_results/AggregateThroughput/AggregateThroughput-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize >> $path_plot/AggregateThroughput-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/DeliveryRate/DeliveryRate-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize >> $path_plot/DeliveryRate-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/DelayMean/DelayMean-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize >> $path_plot/DelayMean-packetSize-$packetSize
		# ./confidenceIntervalAdaptation.sh ci=95  $path_results/JitterMean/JitterMean-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize >> $path_plot/JitterMean-packetSize-$packetSize


		# Per node
		./confidenceIntervalAdaptation.sh ci=95  $path_results/PreqPerNode/Preq-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/Preq-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/PrepPerNode/Prep-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/Prep-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/PerrPerNode/Perr-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/Perr-packetSize-$packetSize
		
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TxPreqPerNode/txPreq-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/txPreq-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TxPrepPerNode/txPrep-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/txPrep-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TxPerrPerNode/txPerr-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/txPerr-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/DroppedTtlPerNode/droppedTtl-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/droppedTtl-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TotalDroppedPerNode/totalDropped-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/totalDropped-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TotalQueuedPerNode/totalQueued-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/totalQueued-packetSize-$packetSize

		# Total
		./confidenceIntervalAdaptation.sh ci=95  $path_results/PreqTotal/PreqTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/PreqTotal-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/PrepTotal/PrepTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/PrepTotal-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/PerrTotal/PerrTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/PerrTotal-packetSize-$packetSize


		./confidenceIntervalAdaptation.sh ci=95  $path_results/TxPreqTotal/TxPreqTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/txPreqTotal-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TxPrepTotal/TxPrepTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/txPrepTotal-packetSize-$packetSize
		./confidenceIntervalAdaptation.sh ci=95  $path_results/TxPerrTotal/TxPerrTotal-nb_nodes-$nb_nodes-interface-$current_interface-flows-$nb_flows-packetInterval-$packetInterval-packetSize-$packetSize-original80211s >> $path_plot/txPerrTotal-packetSize-$packetSize
