...
plt.ylabel('Soma de mensagens de controle na rede')
...
plt.savefig('./plot-nb_nodes-'+nb_nodes+'-'+sufixname+'-sum-txTotal-'+packetSize+'bytes-route-msgs-PT.pdf', bbox_inches="tight")
